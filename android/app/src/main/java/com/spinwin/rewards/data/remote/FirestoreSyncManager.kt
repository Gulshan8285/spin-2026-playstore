        ...
        scope.launch {
            try {
                ...
                val fields = JSONObject().apply {
                    ...
                    put("totalEarned", JSONObject().put("doubleValue", user.totalEarned))
                    put("totalWithdrawn", JSONObject().put("doubleValue", user.totalWithdrawn))
                    put("totalSpins", JSONObject().put("integerValue", user.totalSpins.toString()))
