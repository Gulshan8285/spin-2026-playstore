...
echo "Release Page: https://github.com/Gulshan8285/SpinWinRewards/releases"
echo "Latest Tag:   https://github.com/Gulshan8285/SpinWinRewards/releases/tag/$VERSION"
echo "APK Download: https://github.com/Gulshan8285/SpinWinRewards/releases/download/$VERSION/SpinWinRewards.apk"
echo "AAB Download: https://github.com/Gulshan8285/SpinWinRewards/releases/download/$VERSION/SpinWinRewards.aab"
echo "======================================================"
